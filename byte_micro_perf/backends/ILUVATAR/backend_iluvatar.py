...
from .custom_ops import GPUGemmOp, GPUGemmFP8Op, GPUGroupGemmFP8Op, ILUVATARFlashAttentionOp, GPUFlashMLAOp, ILUVATARGemmOp, ILUVATARGroupGemmOp, ILUVATARAddOp, ILUVATARAllReduceOp
...
OP_MAPPING = {
    ...
    "all_reduce": ILUVATARAllReduceOp, 
    ...
    # "group_gemm": ILUVATARGroupGemmOp,

    # attn ops
    "flash_attention": ILUVATARFlashAttentionOp,
